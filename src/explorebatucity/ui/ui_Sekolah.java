 ...
 * @author Zidan
 */
public class ui_Sekolah extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Silahkan pilih tempat wisata");
        jPanel3.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, 40));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, 40));
        ...
        String sql = "select namatempat from sekolah order by namatempat asc";      
    ...
    public void tampilcb() {
        ...
        Connection con = koneksi.koneksiDB();
        Statement stt = con.createStatement();
        String sql = "select namatempat, info, alamat, jambuka, notelp, programunggulan from sekolah where namatempat='"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ui_Sekolah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
