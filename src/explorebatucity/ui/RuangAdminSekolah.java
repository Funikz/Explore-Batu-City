...
import explorebatucity.kelas.sekolah;
 ...
 * @author Zidan
 */
public class RuangAdminSekolah extends javax.swing.JFrame {

    sekolah app = new sekolah();

    /**
     * Creates new form Admin
     */
    public RuangAdminSekolah() {
        initComponents();
        tampil_combo();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Ruang - Admin Sekolah");
    ...
    private void TombolTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TombolTambahActionPerformed
        ...
        try {
            ...
            app.setProgramunggulan(txtkeunikan.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RuangAdminSekolah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
